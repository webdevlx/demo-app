<template>
        ...
        <div class="col-lg-12">
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="navbar-btn d-none d-lg-inline-block">
              <a @click="sidebar = true" class="menu-bar" href="#side-menu-left"><i class="lni lni-menu"></i></a>
            </div>
          </nav>
          <!-- navbar -->
        </div>
  ...
  <div class="sidebar-left" :class="sidebar ? 'open' : 'close'">
    <div class="sidebar-close">
      <a @click="sidebar = false" class="close" href="#close"><i class="lni lni-close"></i></a>
    </div>
